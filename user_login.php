	...
	if($mobile_number=="")
		...
		if($flag==0)
		{
			$res_password = $db -> get_password_from_mobile_number( $mobile_number);
				...
				if($res_password=="")
				{
					$res_password = "This user is not registered or not verified.";
				}
				else
				{
                                ...
                                <div class="ibox-body">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="checkbox checkbox-pink">
											...
											<a href="user-forgot-password.php" class="input-span" style="float:right;text-decoration:underline;">Forgot Password ?</a>
