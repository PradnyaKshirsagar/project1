<?php 
	 ...
	 if(isset($_GET['delete_id']))
	{
		$delete_id	=	$_GET['delete_id'];
		 $db-> delete_ev_booking($delete_id);
		 $success_msg	=	1;
	}
?>
...
<body class="fixed-navbar">
	...
	?>
                        ...
                        window.location = "ev-booking-report.php";
                        </script>
                        <?php 
	} 
	if($success_msg == 2)
...
?>
                              ...
                              <div class="ibox-body" style="padding:7px; padding-top:0px;">
                                    ...
                                    <div class="ibox-head">
                                          <div class="ibox-title"><i class="fas fa-user-tie"
                                                      style="margin-right:10px;"></i>EV Booking REPORT</div>
                                    </div>
                                    ...
                                    <div class="table-responsive row">
                                          <table class="table table-bordered table-hover" id="example"
                                                ...
                                                <tbody>
                                                      <?php
			//$std_data = $db->get_all_booking();
			$std_data = $db->get_all_booking_from_users_id($email);
			if(!empty($std_data))
			{
				$counter =0;
	  ...
	  <tr class="odd gradeX">
			...
			<td><?php echo "Name : ".$station_name." <br /> Contact : ".$primary_contact." <br /> Address".$city."-".$state."-".$country."-".$pincode; ?></td>
			...
			<td><?php echo $time; ?></td>
			<td class="center"><a
						href="update-ev-booking.php?update_id=<?php echo $id;?>"><i
							  class="far fa-edit"
							  style="color:blue;margin-left:20px;"></i></a>
			</td>
			<td class="center"><a
						href="ev-booking-report.php?delete_id=<?php echo $id;?>"
