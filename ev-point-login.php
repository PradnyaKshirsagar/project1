	...
	if($mobile_number=="")
		...
		if($flag==0)
		{
			$res_password = $db -> get_ev_point_password_from_mobile_number( $mobile_number);
				...
				?>
		<script>
			alert("This CNG/Charging Point is not registered or not verified");
		</script>
		<?php	
				...
				else
				{
					...
					if($var_password==$res_password )
					{
						...
						header("Location: ev-point-dashboard.php");
                                ...
                                <div class="ibox-body">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="checkbox checkbox-pink">
											...
											<a href="ev-point-forgot-password.php" class="input-span" style="float:right;text-decoration:underline;">Forgot Password ?</a>
