...
<div class="page-content fade-in-up">
 ...
 <?php 
	...
	<script type="text/javascript">
		...
		window.location="site-report.php";
	</script>
<?php 
	}
?>
...
<div class="ibox-body" style="padding:7px; padding-top:0px;">
	...
	<div class="ibox-head">
		<div class="ibox-title"><i class="fas fa-user-tie" style="margin-right:10px;"></i>SITE REPORT</div>
		<a href="add-site.php" class="btn btn-primary btn-air"><i class="fas fa-plus">&nbsp;&nbsp;</i>NEW SITE</a>
	</div>
...
<div class="table-responsive row">
	<table class="table table-bordered table-hover" id="example" style="overflow-x:auto;overflow-y:auto;" cellpadding=0 cellspacing=0>
		...
		<tbody>
		<?php
			$report_details = $db->get_all_site_information();
		...
		?>
			<tr class="odd gradeX">
				...
				<td class="center"><a href="update-site.php?update_id=<?php echo $id;?>"><i class="far fa-edit" style="color:blue;margin-left:20px;"></a></td>
				<td class="center"><a href="site-report.php?delete_id=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><i class="fas fa-trash-alt"style="color:red; margin-left:20px;"></i></a></td>
			</tr>
			<?php
					$counter++;
				}
