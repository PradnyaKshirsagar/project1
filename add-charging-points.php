...
{	
	...
	if(isset($_POST['add']))
	{
		...
		if($flag==0)
		{
			$db->add_charging_points($station_name ,$person_name,	$primary_contact,$c_email,$city,$state,$country,$pincode ,$latitude,$longitutde,$open_time,	$close_time,$user_id ,$password);
			$succ_flag = 1 ;
		}
...
<div class="ibox" style="border-radius:5px; padding:7px;">
	 <form class="form-pink" method="post" action="<?php echo $_SERVER['PHP_SELF']?>" name="myForm" onsubmit="return validateForm()" autocomplete="off" enctype="multipart/form-data">
		...
		<div class="ibox-head">
			<div class="ibox-title"><i class="fas fa-user-tie" style="margin-right:10px;"></i>ADD CHARGING POINTS</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 form-group mb-6">
					...
					<div class="input-group-icon input-group-icon-left  set-row">
						...
						<input type="text" name="primary_contact" class="form-control form-control-air" value="<?php echo $primary_contact; ?>" placeholder="Enter Contact Person Mobile Number"   required />
