...
if(isset($_POST['log_btn']))
{
	...
	if($mobile_number=="")
		{
			$mobile_number_error = "Please enter Mobile Number";
			$flag = 1;
		}
		...
		if($flag==0)
		{
			$res_password = $db -> get_ev_point_password_from_mobile_number( $mobile_number);
		
				if($res_password=="")
				{
					$mobile_number_error = "This user is not registered or not verified.";
				}
				else
				{
					
					echo "Your Password is ".$res_password;
				}
		}
					...
					<div class="col-md-6">
						<div class="ibox">
                            <form class="form-pink" method="POST" action="<?php echo $_SERVER['PHP_SELF']?>" name="myForm" onsubmit="return validateForm()" autocomplete="off">
                                ...
                                <div class="ibox-head">
                                    <div class="ibox-title">Forgot Password</div>
                                </div>
                                <div class="ibox-body">
                                  ...
                                  <!--  <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-0">
											...
											<a href="user-forgot-password.php" class="input-span" style="float:right;text-decoration:underline;"></a>
                                    ...
                                    <button class="btn btn-pink btn-air mr-2" type="submit" name="log_btn" >Send Password</button>
