...
<div class="ibox" style="border-radius:5px; padding:7px;">
			<div class="ibox-head">
				<div class="ibox-title"><i class="fas fa-user-tie" style="margin-right:10px;"></i>UPDATE  	CLIENT</div>
			</div>
		...
		<div class="ibox-body">
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 form-group mb-6">
					<label class="form-group mb-4 set-row label_marg"><b>Enter client Name</b></label>
					<div class="input-group-icon input-group-icon-left  set-row">
						<span class="input-icon input-icon-left"><i class="fas fa-user"></i></span>
						<input type="text" name="name" class="form-control form-control-air" value="<?php echo $name; ?>" placeholder="Enter Client Name"  required />
					</div>
				</div>
				<div class="col-sm-6 col-md-6 col-lg-6 form-group mb-6">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 form-group mb-6">
					<label class="form-group mb-4 set-row label_marg"><b>Enter project Name</b></label>
					<div class="input-group-icon input-group-icon-left  set-row">
						<span class="input-icon input-icon-left"><i class="fas fa-building"></i></span>
						<input type="text" name="project_name" class="form-control form-control-air" value="<?php echo $shop_name; ?>" name="shop_name" placeholder="Enter Project Name"   />
					</div>
				</div>
				<div class="col-sm-6 col-md-6 col-lg-6 form-group mb-6">
					<label class="form-group mb-4 set-row label_marg"><b>Enter URL</b></label>
					<div class="input-group-icon input-group-icon-left  set-row">
						<span class="input-icon input-icon-left"><i class="fas fa-building"></i></span>
						<input type="text" name="url" class="form-control form-control-air" value="<?php echo $address; ?>" name="address" placeholder="Enter Url"   />
					</div>
				</div>
				 
				 <div class="col-sm-6 col-md-6 col-lg-6 form-group mb-6">
					<label class="form-group mb-4 set-row label_marg"><b>Enter Project description </b></label>
					<div class="input-group-icon input-group-icon-left  set-row">
						<span class="input-icon input-icon-left"><i class="fas fa-phone"></i></span>
						<input type="number" name="project_description" class="form-control form-control-air" value="<?php echo $other_contact; ?>" placeholder="Enter Project Description"   />
					</div>
				</div>
				<div class="col-sm-6 col-md-6 col-lg-6 form-group mb-6">
				...
				<div class="col-sm-12 form-group mb-12" style="text-align:center; padding-left:0px; padding-right:0px; padding-top:20px;">
					<div class="col-sm-4 form-group mb-4" style="margin:auto;">
						<button class="btn btn-pink btn-air" type="submit" name="add_btn" style="width:100%;">UPDATE CLIENT DETAILS</button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="ibox-head">
			...
			<div class="row">
				...
				?>
					...
					<a href="update-client-info.php"?i_1=<?php echo $logo; ?>">Remove Image</a>
				<br />
				<?php
					}else
					{												
