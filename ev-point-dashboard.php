...
$db		=	new login_function();
	...
	{
		$ev_id	=	$_GET['ev_id'];
		$db->update_ev_set_refilled($ev_id);
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="fixed-navbar">
    <div class="page-wrapper">
	   ...
	   <span style="color:yellow;">Station - <?php echo $current_login_admin;?></span><br />
...
<?php
			$chargin_station_id = $db->get_id_from_login_mob_no($_SESSION['current_login_admin']);

			$std_data = $db->get_all_booking_from_today_date_completed_for_cng($c_date,$chargin_station_id);
		...
		<br />
           ...
           <?php
			...
			<div style="color:white; text-align:center; font-style:italic;">Note : Consider Approx time for CNG refill is 15 to 20 mins. & 30 mint for EV Charging</div>
			 ...
			 <?php
			$std_data = $db->get_all_booking_from_today_date_for_ev_station($c_date,$chargin_station_id);
		...
		?>
		<div style="padding:0px 10px 10px 10px; background-color:white; margin:10px; color:white; display:inline-table; text-align:center; border:1px dashed red; font-weight:bold; border-radius:15px;">
		<?php
		...
		<span style="color:#333;">-<?php echo $user_id; ?></span>
		<br />
		<a href="ev-point-dashboard.php?ev_id=<?php echo $id; ?>" style="color:green;">Set Refilled</a>
		</div>
